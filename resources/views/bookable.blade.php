...
@section('content')
    ...
    @component('components.breadcrumbs')
        ...
        <span>{{ __('site.menu_titles.bookable') }}</span>
    @endcomponent
        ...
        <div>
            <div class="products-header">
                ...
                <div>
                    ...
                    <a href="{{ route('shop.bookable', ['category'=> request()->category, 'sort' => 'low_high']) }}">{{ __('site.menu_titles.lowtohigh') }}</a> |
                    <a href="{{ route('shop.bookable', ['category'=> request()->category, 'sort' => 'high_low']) }}">{{ __('site.menu_titles.hightolow') }}</a>
